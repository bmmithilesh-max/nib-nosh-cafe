...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Nib & Nosh Cafe — Eat. Drink. Play. | Rajajinagar, Bengaluru" },
      {
        name: "description",
        content:
          "A cozy semi-outdoor vegetarian cafe in Rajajinagar, Bengaluru. Wraps, burgers, waffles, sundaes, coffees, board games and party bookings.",
      },
      { property: "og:title", content: "Nib & Nosh Cafe — Eat. Drink. Play." },
      {
        property: "og:description",
        content: "Great food, cool drinks, board games and good vibes in Rajajinagar, Bengaluru.",
      },
    ],
  }),
  component: Index,
...
const galleryImages = [
  { src: "/images/cafe-indoor.jpeg", alt: "Nib & Nosh indoor seating with foosball table" },
  { src: "/images/cafe-courtyard.jpeg", alt: "Nib & Nosh courtyard seating and counter" },
  { src: "/images/cafe-party.jpeg", alt: "Party decor setup at Nib & Nosh" },
];
...
const reviews = [
  {
    name: "Priya R.",
    rating: 5,
    text: "The waffles are absolutely divine and the ambiance is so cozy. Perfect spot for a relaxed evening with friends!",
  },
  {
    name: "Arjun M.",
    rating: 5,
    text: "Came for the jamming night and fell in love with the food. The Sinful Chocolate sundae is a must-try!",
  },
  {
    name: "Sneha K.",
    rating: 5,
    text: "Great place for a party booking. The team was super responsive and the outdoor garden setting is gorgeous.",
  },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-32">
          <div className="max-w-xl">
            ...
            <p className="text-blue-100 text-lg md:text-xl mb-8 leading-relaxed">
              Your neighbourhood haven for great food, cool drinks, and soulful music. Eat. Drink.
              Play.
            </p>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="md:w-2/5">
              ...
              <p className="text-gray-500 leading-relaxed mb-6">
                Nestled beneath a beautiful open-sky glass roof with a majestic tree at the centre,
                Nib & Nosh blends the freshness of the outdoors with the comfort of a cozy cafe.
                Blue chairs, warm lights, and good company make every visit memorable.
              </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-500 mb-8 max-w-xl mx-auto leading-relaxed">
            Whether it's a quiet date, a birthday party, or a live music night – we have something
